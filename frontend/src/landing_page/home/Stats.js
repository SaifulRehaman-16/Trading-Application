    ...
    <div className='container p-5'>
        ...
        <div className='col-6 mt-5 p-5'>
            ...
            <div>
                ...
                <p className='text-muted'> No gimmicks, spam, "gamification", or annoying push notifications. High apps that use at your pace,the way you like.</p>
            </div>
            <div>
            ...
            <div>
                ...
                <p className='text-muted'>With initiatives like Nudge and Kill Switch, we don't just facilitate the transactions,but actively help you do better with your money</p>
            </div>
